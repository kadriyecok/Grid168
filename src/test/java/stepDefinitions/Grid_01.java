...
public class Grid_01 {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.1.133:4444"),new ChromeOptions());
    ...
    void firefoxGriTest() throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.1.133:4444"),new FirefoxOptions());
